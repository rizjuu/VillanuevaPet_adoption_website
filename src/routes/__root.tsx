...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Villanueva Pet Adoption — Find Your Furry Friend" },
      { name: "description", content: "A community pet adoption platform in Villanueva. Adopt loving cats and dogs, donate, and help reduce stray animals." },
      { name: "author", content: "Villanueva Pet Adoption" },
